...
<div class="book">
    ...
    <div class="page">
        ...
        ->where('from', '>=', $from)
        ->where('to', '<=', $to)->whereHas('travelAgents',function ($x){
                    ...
                    <tr>
                        ...
                        @foreach ($dates as $date)
                            <td>
                                ...
                                {{ \App\Models\GuestReservation::where('cancel',Null)->whereHas('travelAgents',function ($x){

                                                               $x->doesnthave('travelAgents');})->where('hotel_id', $hotel->id)->where('date', date('Y-m-d', strtotime($date)))->sum('rooms') }}
@endforeach
                            </td>
                        ...
                        <td>
                            ...
                            {{ \App\Models\GuestReservation::where('cancel',Null)->whereHas('travelAgents',function ($x){
                                                               ...
                                                               $x->doesnthave('travelAgents');})->where('hotel_id', $hotel->id)->where('date', '>=', $from)->where('date', '<=', $to)->sum('rooms') }}
