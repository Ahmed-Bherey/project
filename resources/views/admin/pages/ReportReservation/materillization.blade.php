...
<head>
    ...
    <title>kayan | reservation chart </title>
                    ...
                    <table class=" info ">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td>Available</td>
                                @foreach ($dates as $date)
                                    <td>{{ \App\Models\Hotel::where('id', $hotel->id)->sum('room_no') - \App\Models\GuestReservation::where('cancel',Null)->where('hotel_id',$hotel->id)->where('date', date('Y-m-d', strtotime($date)))->sum('rooms') }}
                                    </td>
                                @endforeach
