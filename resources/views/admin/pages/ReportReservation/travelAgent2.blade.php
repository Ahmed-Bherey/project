                    ...
                    <div class="col-12 col-dm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-hands-helping text-light mr-1"></i>Agent2 chart
                            ...
                            <form class="form-horizontal" action="{{ route('admin.report.show.travel.agent2.hotel') }}"
                                  method="get">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-6 mb-2 mt-2">
                                            <div class="form-floating input-group">
                                                ...
                                                <select class="form-control" id="travel_agent_id"
                                                        name="agent_id">
                                                ...
                                                <label for="HotelName">Travel Agent</label>
                                            </div>
                                        </div>
