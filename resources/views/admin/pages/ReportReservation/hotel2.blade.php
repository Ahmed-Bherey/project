                ...
                <div class="row ">
                    <div class="col-12 col-dm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" action="{{ route('admin.report.arrivalList2.hotel') }}"
                                method="get">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6 mb-2 mt-2">
                                            <div class="form-floating input-group">
                                                ...
                                                <select  class="form-control" id="HotelName" name="hotel_id">
                                        ...
                                        <div class="col-sm-6 mb-2 mt-2">
                                            <div class="form-floating input-group">
                                                ...
                                                <select  class="form-control" id="travelAgent_id"
                                                    name="travelAgent_id">
                                                    <option value="0">Search...</option>
