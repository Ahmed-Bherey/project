...
<head>
    ...
    <title>kayan |Agent Resrvation</title>
...
<div class="book">
    ...
    <div class="page">
        <div class="subpage">
            ...
            <!--start contain-->
            <div class="contain">
                <p class="Attend">Agent: <span>{{ $agent->name }}</span></p>
                <table class=" info ">
                    <thead>
                    <tr>
                        <td>serial</td>
                    ...
                    @foreach ($totals as $key => $total)
                        <tr>
                            ...
                            <td>{{ $total->child }}</td>
                            <td>{{ $total->total }}</td>
                            <td>{{   ((int)$total->total) + ((int)$total->agentBalance) }}</td>
                            <td>{{ -1* ((int)$total->agentBalance )  }}</td>
                    ...
                    <tr @if($totals->lastPage() - $totals->currentPage() != 0) hidden="" @endif>
                        ...
                        <td></td>
                        <td>{{$totalss->sum('total')}}</td>
                        <td>{{   ((int)$totalss->sum('total')) + ((int)$totalss->sum('agentBalance')) }}</td>
                        <td>{{ -1* ((int)$totalss->sum('agentBalance')  ) }}</td>
