                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user-plus mr-1"></i>collect Agent  --- >  {{ str_pad($totals->id, 7, '0', STR_PAD_LEFT)}} //  ---->  Remaing={{  ((int)$totals->agentBalance )}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal needs-validation" novalidate
                                  action="{{ route('admin.collect.agent.reservation.show') }}" method="get">
                                <div class="card-body">
