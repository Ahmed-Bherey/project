                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user-plus mr-1"></i>pay Agent  --- >  {{ str_pad($totals->id, 7, '0', STR_PAD_LEFT)}} //  ----->  Remaing={{  (\App\Models\BankMoves::where('total_id',$totals->id)->sum('pay')+\App\Models\MoneyKeeperMoves::where('total_id',$totals->id)->sum('pay')+\App\Models\VisaMoves::where('total_id',$totals->id)->sum('pay') )}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal needs-validation" novalidate
                                  action="{{ route('admin.pay.agent.reservation.show') }}" method="get">
                                <div class="card-body">
                                    <input name="total_id" value="{{$totals->id}}" hidden >
                                    <div class="row clearfix ps-3 pe-3">
                                        <div class="col-sm-6 mb-3 mt-2">
                                            <div class="form-floating input-group">
                                                ...
                                                <input required class="form-control" value="{{$totals->travelAgents->name}}" name="agentName"
                                        ...
                                        <div class="col-sm-6 mb-3 mt-2">
                                            <div class="form-floating input-group">
                                                ...
                                                <input type="date" required class="form-control" value="<?= date('Y-m-d') ?>" name="date"
                                                       autocomplete="off" size="1" id="hotel" >
