...
<head>
    ...
    <title>kayan |Hotel Resrvation</title>
                ...
                <table class=" info ">
                    ...
                    @foreach ($totals as $key => $total)
                        <tr>
                            ...
                            <td>{{ $total->child }}</td>
                            <td>{{ $total->totalHotel }}</td>
                            <td>{{   ((int)$total->totalHotel) - ((int)$total->hotelBalance) }}</td>
                            <td>{{  ((int)$total->hotelBalance ) }}</td>
                    ...
                    <tr @if($totals->lastPage() - $totals->currentPage() != 0) hidden="" @endif>
                        ...
                        <td>{{$totalss->sum('totalHotel') - $totalss->sum('hotelBalance') }}</td>
                        <td>{{$totalss->sum('hotelBalance') }}</td>
