                    ...
                    <div class="col-12 col-dm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-hands-helping text-light mr-1"></i>Agent chart
                            ...
                            <form class="form-horizontal" action="{{ route('admin.report.show.travel.agent.hotel') }}"
                                  method="get">
