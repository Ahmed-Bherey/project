                    ...
                    <div class="col-12 col-dm-12 col-md-12 col-lg-12 col-xl-10">
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal"
                                  action="{{ route('collection') }}" method="post">
                                @csrf
                                        ...
                                        <div class="form-group row" >
                                            ...
                                            <div class="col-sm-12 col-12 col-md-10">
                                                <input type="number" class="form-control" id="rate" placeholder="" name="rate"
                                                       value="{{ $hotelContract->rate }}" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="date" class="col-sm-12 col-12 col-md-2 col-form-label">Date From</label>
                                            <div class="col-sm-12 col-12 col-md-10">
                                                <input type="date" class="form-control" id="date" placeholder="" name="from"
                                                       required>
                                            </div>
                                        </div> <div class="form-group row">
                                            <label for="date" class="col-sm-12 col-12 col-md-2 col-form-label">Date TO</label>
                                            <div class="col-sm-12 col-12 col-md-10">
                                                <input type="date" class="form-control" id="date" placeholder="" name="to"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
