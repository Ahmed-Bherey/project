                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-user-plus mr-1"></i>Hotel Collect </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal needs-validation" novalidate
                            action="{{ route('hotel.collection.collect') }}" method="post">
                            @csrf
                            <div class="card-body">
                                {{-- --}}
                                    ...
                                    <div class="col-sm-6 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            ...
                                            <input type="number" class="form-control input" placeholder="amount"
                                                name="amount" required step="0.01" id="tel">
                                            {{-- invalid --}}
