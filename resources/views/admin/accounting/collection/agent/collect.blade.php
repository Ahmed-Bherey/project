                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-user-plus mr-1"></i>Agent Collect </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal needs-validation" novalidate
                            action="{{ route('agent.collection.collect') }}" method="post">
                            @csrf
                            <div class="card-body">
                                {{-- --}}
                                <div class="row clearfix ps-3 pe-3">
                                    ...
                                    <div class="col-sm-4 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            ...
                                            <input type="date" value="<?= date('Y-m-d') ?>" required
                                                class="form-control" name="date" id="meal">
                                    ...
                                    <div class="col-sm-4 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            <input required class="form-control" name="agentName" list="agent_ids"
                                                autocomplete="off" size="1" oninput="handleValueChange()" id="textbox_id" placeholder="guest name ...">
                                            <datalist id="agent_ids" size="10" >
                                                @foreach ($agents as $agent)
                                                <option value="{{ $agent->name }}" data-balance="{{$agent->balance}}">
                                                    @endforeach
                                            </datalist>
                                    ...
                                    <div class="col-sm-4 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            ...
                                            <input required class="form-control"   id="balance"
                                ...
                                <div class="row clearfix ps-3 pe-3">
                                    ...
                                    <div class="col-sm-4 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            ...
                                            <select required class="form-control" name="kindPush_id" id="kindPush_id">
                                    ...
                                    <div class="col-sm-6 mb-3 mt-2">
                                        <div class="form-floating input-group">
                                            ...
                                            <input type="number" class="form-control input" placeholder="amount"
                                                name="amount" step="0.01" id="tel" required>
                                            {{-- invalid --}}
...
<script>
    function handleValueChange() {
        let y = document.getElementById('textbox_id').getAttribute("data-balnce");
    ...
    {{--<script type="text/javascript">--}}
        {{--$(document).ready(function() {--}}
            {{--$('input[name="agentName"]').on('change', function() {--}}
                {{--var stateID = $(this).val();--}}
                {{--var csrf = $('meta[name="csrf-token"]').attr('content');--}}

                {{--var route = '{{route('admin.show.agent.',['id' =>': id'])}}';--}}
                {{--route = route.replace(':id', stateID);--}}
                {{--if (stateID) {--}}
                    {{--$.ajax({--}}
                        {{--beforeSend: function(x) {--}}
